...
def render_sidebar(training_text, training_pclass, training_sclass, accuracies):
    ...
    with st.sidebar:
        st.markdown('<h1 style="font-size:15px">Laurant.CAI</h1>', unsafe_allow_html=True)
        st.markdown('<h1 style="font-size:10px">Logistic Regression Classification Artificial Intelligence</h1>', unsafe_allow_html=True)
