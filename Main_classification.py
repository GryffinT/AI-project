...
with st.sidebar:
    ...
    scatter1 = axes[0].scatter(st.session_state.X_pca[:, 0], st.session_state.X_pca[:, 1],
                               c=st.session_state.p_labels_encoded, cmap='tab10',
    ...
    scatter2 = axes[1].scatter(st.session_state.X_pca[:, 0], st.session_state.X_pca[:, 1],
                               c=st.session_state.s_labels_encoded, cmap='tab20',
                               alpha=0.7, edgecolor='k')
    ...
    # Show model accuracies (also store in session_state)
